...
@app.route('/language')
def getanguage():
    filepath = '/home/raghad/Desktop/fr.wav'
    ...
    savedmodel_path=args["model"]
    voices_features_path= args["features"]
...
if __name__ == '__main__':
    ...
    ap.add_argument("-o", "--opensmile", type=str, required=True,
                    help="path to open smile")
    ap.add_argument("-m", "--model", required=True,
                    help="path to saved model.h5")
    ap.add_argument("-f", "--features", type=str, required=True,
                    help="voice features data voiceData.csv`")
